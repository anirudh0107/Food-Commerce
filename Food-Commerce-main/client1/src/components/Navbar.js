    ...
    <nav className="bg-gray-800 p-4">
      <div className="flex justify-between items-center">
        ...
        <img
            ...
            />
          <Link to="/home" className="text-white py-5">Home</Link>
          <Link to="/about" className="text-white py-5">About</Link>
          <Link to="/contact" className="text-white py-5">Contact</Link>
        ...
        <div className="flex space-x-4 items-center">
          {username ? (
            <>
              <Link to="/updateuser-profile" className="text-blue-400 hover:text-blue-700 transition-colors">Update Profile</Link>
              <img
